...
import { calculateGasMargin, calculateSlippageAmount, getRouterContract, isHecoChain } from '../../utils'
                    ...
                    {chainId && (oneCurrencyIsWETH || oneCurrencyIsETH) ? (
                      <RowBetween style={{ justifyContent: 'flex-end' }}>
                        {oneCurrencyIsETH ? (
                          ...
                          >
                            Receive {chainId && isHecoChain(chainId) ? 'WHT' : 'WETH'}
                          </StyledInternalLink>
                        ) : oneCurrencyIsWETH ? (
                          <StyledInternalLink
                            to={`/remove/${
                              currencyA && currencyEquals(currencyA, WETH[chainId]) ? isHecoChain(chainId) ? 'HT' : 'ETH' : currencyIdA
                            }/${currencyB && currencyEquals(currencyB, WETH[chainId]) ? isHecoChain(chainId) ? 'HT' : 'ETH' : currencyIdB}`}
                          >
                            Receive {chainId && isHecoChain(chainId) ? 'HT' : 'ETH'}
                          </StyledInternalLink>
                        ) : null}
                      </RowBetween>
                    ) : null}
